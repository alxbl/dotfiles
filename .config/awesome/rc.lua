...
-- Global Keybindings {{{
globalkeys = awful.util.table.join(KEYMAP,
...
-- Standard client bindings
clientkeys = awful.util.table.join(
awful.key({ VARS.altkey, "Shift"   }, "m",      lain.util.magnify_client                         ),
awful.key({ VARS.modkey, }, "w",      function (c) c:kill()                         end, {description = "close", group = "client"}),
awful.key({ VARS.modkey, "Control" }, "space",  awful.client.floating.toggle                     , {description = "toggle floating", group = "client"}),
awful.key({ VARS.modkey, "Control" }, "Return", function (c) c:swap(awful.client.getmaster()) end, {description = "move to master", group = "client"}),
awful.key({ VARS.modkey, "Shift"   }, "o",      function (c) c:move_to_screen()               end, {description = "move to screen", group = "client"}),
...
-- Bind all key numbers to tags.Use keycodes to make it works on any keyboard layout.
for i = 1, 9 do
...
-- Core shortcuts in rc.lua to ensure they are available.
globalkeys = awful.util.table.join(globalkeys,
...
awful.rules.rules = {
    ...
    properties = { border_width = beautiful.border_width,
            ...
            focus = awful.client.focus.filter, -- TODO: Use a focus filter.
            raise = true,
            keys = clientkeys,
    ...
    { rule = { class = "rdesktop" },
    properties = { screen = 2, fullscreen = true, titlebars_enabled = false} },
}
-- }}}
