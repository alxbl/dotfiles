...
keys.global = gears.table.join(
    ...
    awful.key({ MOD,     }, "Tab",    utils.pick_wnd,          {description = "open window picker", group = "awesome"}),
    awful.key({ ALT,     }, "Tab",    utils.pick_wnd,          {description = "open window picker", group = "awesome"}),
