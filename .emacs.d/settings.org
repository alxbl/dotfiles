       ...
       :custom
         ...
         (org-capture-templates
          '(("t" "Add todo item" entry (file+headline tasks-file "Tasks")
            ...
            ("p" "Add Personal Note" item (file+olp+datetree diary-file "Diary"))
            ("r" "Perform Daily Review" entry (file+olp+datetree diary-file "Diary")
              (file "~/.emacs.d/templates/daily.org") :immediate-finish t) 
            ("w" "Add Work Note" checkitem (file+olp+datetree work-file  "Diary"))
            ))
       :config
